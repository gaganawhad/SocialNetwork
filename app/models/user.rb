...
class User < ActiveRecord::Base
  ...
  attr_accessible :login, :email, :name, :password, :password_confirmation, :first_name, :last_name, :gender, :picture_file_name, :picture_content_type, :picture_file_size, :picture_updated_at, :address_id, :address_attributes, :picture, :phone_number, :life_status, :movies, :books
